...
def feature_extraction():
    ...
    d_innout = get_in_door_outdoor("StudentLife_Dataset/Inputs/sensing/wifi_location")
...
#        
    ...
    return x_train_positive,x_train_negative,x_train_flurishing,y_train_pos_score,y_train_neg_score,y_train_flourishing