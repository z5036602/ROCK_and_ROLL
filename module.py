...
George
Just do:
from module.py import get_features
'''
import pandas as pd
import os
...
def get_features():    
    ...
    for i in range(60):
        ...
        fea = d_activity[u] + d_audio[u] + d_conversation[u] + d_dark[u] + d_phone_lock[u] \
            +d_phone_charge[u] + d_gps[u] + d_wifi[u] + d_wifi_location[u] + d_get_bluetooth[u]
    ...
    return x_flourishing_dataset, y_flourishing_dataset, x_panas_dataset, y_panas_postive_dataset, x_panas_dataset, y_panas_negative_dataset